    $(function(){
        ...
        // 判断浮点数value是否等于0
        jQuery.validator.addMethod("eqFloat", function(value, element,param) {
            value=parseFloat(value);
            var _eqVal=parseFloat(param);
            return this.optional(element) || value ==_eqVal;
        }, "浮点数必须小于或等于{0}");
        // 判断浮点数value是否小于或等于0
        ...
        jQuery.validator.addMethod("isPwd", function(value, element) {
            return this.optional(element) || /^[a-zA-Z]\\w{6,32}$/.test(value);
