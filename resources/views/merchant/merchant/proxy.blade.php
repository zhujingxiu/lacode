                    ...
                    <td class="c">
                        ...
                        <table border="0" cellspacing="0" class="conter">
                            ...
                            <tr align="center" style="height: 22px;" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                ...
                                <td>0%</td>
                                <td class="dfg bg_l">
                                    <a href="{{route('merchant.member')}}?merchant={{$merchant->name}}" data-pjax="true">{{$merchant->name}}</a>
                                </td>
                                ...
                                <td>
                                    @if($merchant->info->order_now)
                                        <img src="/img/merchant/img_4.gif">
                                    @else
                                ...
                                @empty
                                    <tr align="center">
                                        <td colspan="18"><font color="red"><b>當前沒有數據······</b></font></td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
