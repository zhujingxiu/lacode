                            ...
                            <td background="/img/merchant/tab_05.gif">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tbody><tr>
                                        ...
                                        <td><font style="font-weight:bold" color="#344B50">&nbsp;总公司管理</font></td>
                                        <td width="56%">
                                        ...
                                        <td align="right" width="60"><a data-pjax="true" href="{{route('merchant.user-create',$role->code)}}">新增分公司</a></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </td>
                            ...
                            <td class="c">
                                ...
                                <table border="0" cellspacing="0" class="conter">
                                    ...
                                    <tr align="center" style="height:22px" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                        ...
                                        <td class="bg_l">{{bcsub(100,$merchant->info->rate)}}%</td>
                                        <td class="dfg bg_l">
                                            <a data-pjax="true" href="{{route('merchant.user-shareholder')}}?parent={{$merchant->name}}">{{$merchant->name}}</a>
                                        </td>
                                        <td class="bg_l">{{$merchant->info->rate*1}}%</td>
                                        <td align="left">&nbsp;{{$merchant->nick_name}}</td>
                                        <td style="font-size:110%">
                                            <strong><a href="{{route('merchant.user-shareholder')}}?parent={{$merchant->name}}" data-pjax="true">{{$merchant->shareholder_count}}</a></strong>
                                        </td>
                                        <td style="font-size:110%">
                                            <strong><a href="{{route('merchant.user-agent')}}?parent={{$merchant->name}}" data-pjax="true">{{$merchant->agent_count}}</a></strong>
                                        </td>
                                        <td style="font-size:110%">
                                    ...
                                    @empty
                                        <tr align="center">
                                            <td colspan="14"><font color="red"><b>當前沒有數據······</b></font></td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
