                            ...
                            <td background="/img/merchant/tab_05.gif">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tbody><tr>
                                        ...
                                        <td><font style="font-weight:bold" color="#344B50">&nbsp;股東管理</font></td>
                                        <td width="56%">
                                        ...
                                        <td align="right" width="60"><a href="{{route('merchant.user-create',$role->code)}}">新增股東</a></td>
                                    </tr>
                                    </tbody>
                                </table>
                            ...
                            <td class="c">
                                ...
                                <table border="0" cellspacing="0" class="conter">
                                    ...
                                    <tr align="center" style="height: 22px;" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                        ...
                                        <td>{{bcsub($merchant->parent->info->rate,$merchant->info->rate) }}%</td>
                                        <td class="dfg bg_l">
                                            <a href="{{route('merchant.user-agent')}}?parent={{$merchant->name}}" data-pjax="true">{{$merchant->name}}</a>
                                        </td>
                                        ...
                                        <td>
                                            @include('merchant.merchant.status',['merchant'=>$merchant])
                                        </td>
                                    </tr>
                                        @empty
                                                <tr align="center">
