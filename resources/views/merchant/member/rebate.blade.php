...
@section('content')
    <div id="page-content">
        <form action="{{route('merchant.member-rebate', $member)}}" method="post" id="rebate-form">
            {{csrf_field()}}
            <table border="0" cellspacing="0" cellpadding="0" class="Main">
                ...
                <tr>
                    ...
                    <td class="main_top">
                        ...
                        退水設定 -&gt;会员（<span style="font-weight:normal">{{$member->name}}</span>）
                            <div style="float: right">会员名稱：{{$member->nick_name}}</div>
                        </div>
                    </td>
                    ...
                    <td class="Main_conter">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" class="tableTrait">
                            ...
                            <tr class="traitTop Ct">
                                <td width="30%" >調整項目</td>
                                <td width="5%" ></td>
                                @if($member->info->roulette=='a')
                                <td width="12%" >A盤</td>
                                @endif
                                @if($member->info->roulette=='b')
                                <td width="12%" >B盤</td>
                                @endif
                                @if($member->info->roulette=='c')
                                <td width="12%" >C盤</td>
                                @endif
                                <td width="12%">單註限額</td>
                                <td width="12%">單期限額</td>
                        ...
                        <table border="0" cellspacing="" cellpadding="0" class="tableRebate">
                            ...
                            <tr class="rebateLine" id="rebate-line-{{$option->id}}">
                                ...
                                @php
                                $_rebate = isset($member_rebates[$option->id]) ? $member_rebates[$option->id] : [];
                                $_parent_rebate = isset($merchant_rebates[$option->id]) ? $merchant_rebates[$option->id] : [];
