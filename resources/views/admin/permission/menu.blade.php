        ...
        <div class="col-sm-7">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-inline" action="{{route('admin.menu.store')}}">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            <td><a>{{$menu->title}}</a></td>
                            <td>
                                @if(isset($menu->parent) && $menu->parent->title)
                                [<a class="btn-link">{{$menu->parent->title}}</a>]
                                    @endif
                            </td>
                            <td>{{$menu->style}}</td>
                            <td>{{$menu->icon}}</td>
                            <td>{{$menu->sort}}</td>
                            <td><input type="checkbox" id="status-{{$loop->iteration}}" class="magic-checkbox" {{$menu->status==1 ? 'checked' : ''}}>
                                <label for="status-{{$loop->iteration}}">是</label>
                            </td>
                            <td>
