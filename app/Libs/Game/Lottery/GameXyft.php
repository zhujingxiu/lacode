...
class GameXyft extends BaseGame
{
    use RuleSc10;
    ...
    protected $default_schedules = [
        ['start_time'=>'13:04:00','total'=>180,'interval'=>5*60,'ahead'=>'50', 'sort'=>'1'],
    ];
    protected function generateNumbers()
    {
        $_api_url = 'https://www.ss1300.com:8090/api/newest?code=zyft01&t=' . time();
